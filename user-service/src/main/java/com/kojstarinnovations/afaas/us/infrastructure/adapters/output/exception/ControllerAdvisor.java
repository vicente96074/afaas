package com.kojstarinnovations.afaas.us.infrastructure.adapters.output.exception;

import com.kojstarinnovations.afaas.commons.exception.*;
import com.kojstarinnovations.afaas.us.infrastructure.adapters.output.exception.response.ExceptionResponse;
...
public class ControllerAdvisor extends ResponseEntityExceptionHandler {
    ...
    /**
     * No authorized to access this resource
     *
     * @param ex      the ex
     * @param request the request
     * @return the response entity
    ...
    public final ResponseEntity<Object> handleBadCredentialsException(BadCredentialsException ex, WebRequest request) {
        ExceptionResponse exceptionResponse = new ExceptionResponse(LocalDateTime.now(), "Bad credentials: " + ex.getMessage(), List.of(request.getDescription(false)));
